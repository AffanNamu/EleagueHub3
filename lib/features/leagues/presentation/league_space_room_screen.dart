...
State createState() => _LeagueSpaceRoomScreenState();



}

class _LeagueSpaceRoomScreenState extends State {
...
Future _enforceLocalMutePolicy() async {
...
Future _handleUnexpectedDisconnect() async {



// No auto-reconnect, no token refresh, no republish.
...
Future _disconnectAudio({bool showToast = true}) async {
...
Future _sendReaction(String emoji) async {
...
Future _approveRequest(String userId) async {
...
Future _denyRequest(String userId) async {
...
Future _removeSpeaker(String userId) async {
...
Future _toggleMuteSpeaker(String userId, bool muted) async {
...
try {
  ...
  // Firestore state is authoritative for UI; LiveKit moderation is best-effort.
                    ...
                    Expanded(
                      ...
                      child: FilledButton.icon(
                        ...
                        icon: _joiningAudio
                            ...
                            : Icon(_room != null ? Icons.call_end : Icons.headset),

                        label: Text(_room != null ? 'Leave Audio' : 'Join Audio'),
