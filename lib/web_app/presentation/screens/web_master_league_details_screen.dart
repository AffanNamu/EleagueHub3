...
import '../../../features/leagues/presentation/widgets/join_league_mode_sheet.dart';
import '../../../features/master_leagues/domain/competition_template.dart';
...
class WebMasterLeagueDetailsScreen extends ConsumerStatefulWidget {
  const WebMasterLeagueDetailsScreen({
    super.key,
  ...
  @override
  ConsumerState<WebMasterLeagueDetailsScreen> createState() =>
      _WebMasterLeagueDetailsScreenState();
}

class _WebMasterLeagueDetailsScreenState
    extends ConsumerState<WebMasterLeagueDetailsScreen> {
  bool _busy = false;
  ...
  Future<void> _showCreateCompetitionSheet(
    ...
    final selected = await showDialog<LeagueFormat>(
      context: context,
      builder: (ctx) {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      'This action will permanently delete your workspace, including all leagues, players, and data. This cannot be undone.',
                      style: TextStyle(
                        color: Theme.of(ctx).colorScheme.error,
                        fontWeight: FontWeight.w900,
                        height: 1.35,
                    ...
                    TextField(
                      controller: ctrl,
                      onChanged: (v) => setStateDialog(() => typed = v),
                      decoration: InputDecoration(
  ...
  void _openOrganizerProfile(MasterLeague master) {
    context.push('/master-leagues/${master.id}/organizer-profile');
  }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ...[
                  ('rename', Icons.edit_outlined, 'Rename Master League'),
                  ('profile', Icons.badge_outlined, 'Organizer Profile'),
                  ('admin', Icons.admin_panel_settings_outlined, 'Add Admin'),
                  ('moderator', Icons.shield_outlined, 'Add Moderator'),
                  ('delete', Icons.delete_forever_outlined, 'Delete Workspace'),
                ].map((item) {
                  final destructive = item.$1 == 'delete';
                  return Padding(
                    padding: const EdgeInsets.only(bottom: 10),
                    child: InkWell(
  ...
  Future<void> _showAllCompetitionsDialog(
    MasterLeague master,
    List<League> leagues,
    ThemeData theme,
  ) async {
  ...
  Widget _buildOwnerQuickActions(
    ...
    return _panel(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _sectionTitle('Owner Quick Actions'),
          const SizedBox(height: 14),
          tile(
  ...
  Widget _buildVisitorOverview(
    ...
    return _panel(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _sectionTitle('Organizer Overview'),
          const SizedBox(height: 12),
          item(
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              children: [
                                _tag(
                                  icon: Icons.auto_awesome_outlined,
                                  label: preview.format.displayName,
                                ),
                                _tag(
                            ...
                            const SizedBox(height: 14),
                            Text(
                              'Open the competition page, or join directly if you are not yet a participant.',
                              style: theme.textTheme.bodyMedium?.copyWith(
                                color: AppTheme.secondaryText(brightness),
                                fontWeight: FontWeight.w700,
                                height: 1.45,
                            ...
                            Wrap(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: OutlinedButton.icon(
                                    onPressed: () =>
                                        context.push('/leagues/${preview.id}'),
                                    icon: const Icon(Icons.open_in_new_rounded),
                                    label: const Text(
                                      'Open Competition',
                                      style: TextStyle(fontWeight: FontWeight.w900),
                            ...
                            if (remaining > 0) ...[
                              ...
                              SizedBox(
                                width: 260,
                                child: FilledButton.tonalIcon(
                                  onPressed: () => _showAllCompetitionsDialog(
                                    master,
                                    leagues,
                                    theme,
                                  ),
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: preview.leagueImageUrl.trim().isNotEmpty
                                ? DecorationImage(
                                    image: NetworkImage(
                                      preview.leagueImageUrl.trim(),
                                    ),
                                    fit: BoxFit.cover,
                                  )
                                : null,
                          ),
                          child: preview.leagueImageUrl.trim().isNotEmpty
                              ? Container()
                              : Center(
                                  child: Icon(
                                    Icons.emoji_events_outlined,
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: master.organizerProfile.logoUrl.trim().isNotEmpty
                          ? DecorationImage(
                              image: NetworkImage(
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    children: [
                      InkWell(
                        onTap: () => context.go('/master-leagues'),
