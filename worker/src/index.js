...
* Mute/unmute ALL published audio tracks for an identity (no trackSid from clients needed).
*/
...
if (url.pathname === "/" && request.method === "POST") {
  ...
  // Everyone can publish from the start so clients publish ONCE (muted) and later only unmute.
  at.addGrant({
    room: roomName,
    roomJoin: true,
    canSubscribe: true,
